...
public function index(Request $request)
{
    ...
    $statuts = [
        'À Rappeler', 'NRP', 'À Retraiter', 'Confirmer Régie', 'Confirmé',
        'VT Programmée', 'VT Réalisée', 'Chantier Programmé', 'Nettoyage',
        'Installer 100%', 'Remplacement', 'Chantier Annulé', 'Annulé Tôle',
        'SAV', 'SAV Réalisé'
    ];
